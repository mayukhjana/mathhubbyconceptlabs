          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 justify-center lg:justify-start animate-fade-in">
              <div className="flex -space-x-4">
                ...
                <div className="w-12 h-12 rounded-full border-4 border-white dark:border-gray-800 overflow-hidden shadow-lg">
                  <img src="https://images.unsplash.com/photo-1581090464777-f3220bbe1b8b" alt="Student C" className="w-full h-full object-cover" />
                </div>
                <div className="w-12 h-12 rounded-full border-4 border-white dark:border-gray-800 overflow-hidden shadow-lg">
                  <img src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce" alt="Student D" className="w-full h-full object-cover" />
                </div>
                <div className="w-12 h-12 rounded-full border-4 border-white dark:border-gray-800 overflow-hidden shadow-lg">
                  <img src="https://images.unsplash.com/photo-1629872430082-93d8912beccf" alt="Student E" className="w-full h-full object-cover" />
                </div>
              </div>
              <div>
