          ...
          <CarouselContent>
            {testimonials.map((testimonial, index) => (
              <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                <div className="h-full bg-card border border-border p-6 md:p-8 rounded-2xl hover:shadow-xl hover:border-mathprimary/30 transition-all duration-300 relative">
                  <div className="text-6xl text-mathprimary/10 absolute top-4 left-4">"</div>
                  <p className="text-muted-foreground leading-relaxed mb-6 relative z-10">
                    {testimonial.content}
                  </p>
                  <div className="flex items-center gap-3 border-t border-border pt-4 mt-auto">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-mathprimary/20 to-mathaccent/20 overflow-hidden ring-2 ring-mathprimary/20">
